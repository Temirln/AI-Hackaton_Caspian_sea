...
def get_data(long, lat, start_date, end_date):
  ...
  #   'maxPixels':10000000
  # })
  vectors = ndwiMasked1.reduceToVectors(scale = 1000.0, geometryType = 'polygon', eightConnected = False, maxPixels = 10000000, bestEffort=True)
  ...
  Map.to_streamlit(width = 1000, height=900)
